...
FROM (
	...
	FROM 
		...
		SELECT 
			...
			CASE WHEN CLEAN_STRING(SRC.CARR_ADMN_SYS_CD)='Combnd' THEN CLEAN_STRING('SLA') ELSE CLEAN_STRING('IPA') END AS IPA,
...
FROM (
	...
	FROM 
		( 
			...
			CASE WHEN CLEAN_STRING(PD.CARR_ADMN_SYS_CD)='Combnd' THEN CLEAN_STRING('SLA') ELSE CLEAN_STRING('IPA') END AS IPA,
