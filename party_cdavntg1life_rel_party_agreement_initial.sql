...
/*
    ...
    ---------------------------------------------------------------------------------------------------------------
    JIRA               Party-Tier2                09/03      First Version of DML for Tier-2
...
DELETE FROM EDW.REL_PARTY_AGREEMENT WHERE SOURCE_SYSTEM_ID IN ('241','38') AND SOURCE_BENEFICIARY_ROLE_CDE='Bene';
...
BENEFICIARY_UNFORMATTED_NM
FROM
EDW_WORK.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT;
