/*
    ...
    Author: MM69917
    SUBJECT AREA : Party
    SOURCE: CDA_VNTG1LIFE
    Teradata Source Code: 38
    ===============================================================================================================
    Version/JIRA Story#     Created By     Last_Modified_Date   Description
    ---------------------------------------------------------------------------------------------------------------
    JIRA 3522               Party-Tier2    09/02                Initial version
    ------------------------------------------------------------------------------------------------------------------
*/

TRUNCATE TABLE EDW_STAGING.PARTY_CDAVNTG1LIFE_DIM_PARTY_PRE_WORK;

TRUNCATE TABLE EDW_WORK.PARTY_CDAVNTG1LIFE_DIM_PARTY;

INSERT INTO  EDW_STAGING.PARTY_CDAVNTG1LIFE_DIM_PARTY_PRE_WORK
(
...
(
SELECT 
    UUID_GEN( bene_name_first, bene_name_middle, bene_name_last,
              bene_row_adm_sys_name, bene_row_ctrt_prefix, bene_row_ctrt_no, bene_row_ctrt_suffix,
              bene_arrngmt, bene_row_cntr)::UUID AS DIM_PARTY_NATURAL_KEY_HASH_UUID,
...
FROM EDW_STAGING.PARTY_CDAVNTG1LIFE_DIM_PARTY_PRE_WORK SRC
...
(
    ...
    (	
     ...
     FROM EDW_STAGING.PARTY_CDAVNTG1LIFE_DIM_PARTY_PRE_WORK S
