...
set ofc_id=q1.ofc_id_new,row_process_dtm=current_timestamp(6)
from(
...
from EDW_STAGING.IDM_BR_HIER_OFC_SNAPSHOT where length(clean_string(voltageaccess(ofc_id,'sorparty')))<>10
)q1
