/*
    FileName: party_cdavntg1life_rel_party_agreement.sql
    Author: MM14803
    Subject Area : Party
    Source: CDA VNTG1 LIFE
    Create Date:2021-98-01
       
    ===============================================================================================================
    Version/JIRA Story#     Created By     Last_Modified_Date   Description
    ---------------------------------------------------------------------------------------------------------------
    TERSUN-             Party-Tier2        09/03         Initial version      
    ------------------------------------------------------------------------------------------------------------------
*/

TRUNCATE TABLE EDW_STAGING.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT_PRE_WORK;
...
DROP TABLE IF EXISTS TEMP_VNTG1_CTRT_DIM_AGREEMENT_TBL ;
CREATE LOCAL TEMPORARY TABLE TEMP_VNTG1_CTRT_DIM_AGREEMENT_TBL ON COMMIT PRESERVE ROWS AS
SELECT 
...
FROM (			
		...
		FROM EDW_STAGING.CDA_VNTG1_LIFE_EDW_CONTRACT_DELTA_SNAPSHOT SRC1 
		...
		SELECT DISTINCT
						...
						LPAD(CLEAN_STRING(ctrt_row_ctrt_no),20,'0')		AS CTRT_ROW_CTRT_NO,
						UDF_ISNUM_LPAD(CLEAN_STRING(ctrt_row_ctrt_suffix), 20, '0', TRUE)		AS CTRT_ROW_CTRT_SUFFIX
		FROM EXT_EDAP_STAGING.CDA_VNTG1_LIFE_EDW_CONTRACT_DELTA SRC2
		WHERE PROCESS_IND='D'
	  ) A ;
...
INSERT INTO EDW_STAGING.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT_PRE_WORK
(
	DIM_AGREEMENT_NATURAL_KEY_HASH_UUID,
	DIM_PARTY_NATURAL_KEY_HASH_UUID,
	REF_PARTY_ROLE_NATURAL_KEY_HASH_UUID,
...
INNER JOIN TEMP_VNTG1_CTRT_DIM_AGREEMENT_TBL CTRT ON CTRT.DIM_AGREEMENT_NATURAL_KEY_HASH_UUID=DEDUP.DIM_AGREEMENT_NATURAL_KEY_HASH_UUID   
...
AND (
	...
	(
		...
		REF_PARTY_ROLE_NATURAL_KEY_HASH_UUID,
		REF_PARTY_SUB_ROLE_NATURAL_KEY_HASH_UUID
		FROM EDW_STAGING.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT_PRE_WORK
	);
...
INSERT INTO EDW_WORK.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT
(
	DIM_AGREEMENT_NATURAL_KEY_HASH_UUID,
	DIM_PARTY_NATURAL_KEY_HASH_UUID,
	REF_PARTY_ROLE_NATURAL_KEY_HASH_UUID,
...
FROM EDW_STAGING.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT_PRE_WORK SRC
...
SELECT ANALYZE_STATISTICS('EDW_WORK.PARTY_CDAVNTG1LIFE_REL_PARTY_AGREEMENT');
