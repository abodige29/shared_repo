...
SELECT DIM_AGREEMENT_NATURAL_KEY_HASH_UUID_OLD,DIM_AGREEMENT_NATURAL_KEY_HASH_UUID_NEW FROM (
SELECT
UUID_GEN(CLEAN_STRING(CARR_ADMN_SYS_CD),
CLEAN_STRING('IPA'),
CLEAN_STRING(HLDG_KEY_PFX),
...
ROW_NUMBER() OVER(PARTITION BY DIM_AGREEMENT_NATURAL_KEY_HASH_UUID_OLD,DIM_AGREEMENT_NATURAL_KEY_HASH_UUID_NEW) AS RNK
FROM
(
SELECT
...
*/
 ...
 UPDATE EDW.REL_PARTY_AGREEMENT TGT
