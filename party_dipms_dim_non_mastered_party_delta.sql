...
SELECT A.*,ROW_NUMBER () OVER (PARTITION BY DIM_NON_MASTERED_PARTY_NATURAL_KEY_HASH_UUID ORDER BY LST_UPDT_DT)
AS RW_NUM
FROM PRE_WORK A ORDER BY DIM_NON_MASTERED_PARTY_NATURAL_KEY_HASH_UUID;
