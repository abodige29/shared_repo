/*
    ...
    ---------------------------------------------------------------------------------------------------------------
    		               Party-Tier2         08/04           First Version Tier-2 
    ------------------------------------------------------------------------------------------------------------------
*/ 
...
FROM(
SELECT 
'Dipms_'||CLEAN_STRING(VOLTAGEACCESS(GRP_NB,'account_char')) AS PARTY_ID,
...
-----select count(*) from PRE_WORK2;     --620687
...
AND A.RW_NUM=B.RW_NUM-1; --Updated Rows	620687
