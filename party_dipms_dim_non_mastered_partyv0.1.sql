...
:audit_id AS AUDIT_ID,                                          -- default this to -1
...
:audit_id AS UPDATE_AUDIT_ID,                                   -- default this to -1
SOURCE_DELETE_IND,
'I' AS PARTY_TYPE_CDE
FROM (
SELECT 
...
BEGIN_DTM,
CURRENT_TIMESTAMP(6)  AS ROW_PROCESS_DTM,
:audit_id AS AUDIT_ID,                                    -- default it to -1
FALSE AS LOGICAL_DELETE_IND,
...
'342' AS SOURCE_SYSTEM_ID,
FALSE AS RESTRICTED_ROW_IND,
:audit_id AS UPDATE_AUDIT_ID,                             -- default it to -1  
...
WHERE RNK=1; --Updated Rows	292874
...
PREEXISTING_CONDITION_LIMITATION_ID,
DUE_DT_ALIGNMENT_IND,
VOLTAGEPROTECT(SERVICING_AGENCY_ID,'account_char') AS SERVICING_AGENCY_ID,
SOURCE_MARKET_CDE,
MARKET_CDE,
MARKET_CDE_EFFECTIVE_DT,
SOURCE_SALES_CATEGORY_CDE,
...
ENDR_IND,
ENDR_DT,
VOLTAGEPROTECT(SERVICING_AGENT_ID,'account_char') AS SERVICING_AGENT_ID,
SOURCE_BILLING_FREQUENCY_CDE,
BILLING_FREQUENCY_CDE,
SOURCE_BILL_TYPE_CDE,
BILLING_TYPE_CDE,
...
CLEAN_STRING(VOLTAGEACCESS(SVCNG_AGY,'account_char')) AS SERVICING_AGENCY_ID,
...
CLEAN_STRING(VOLTAGEACCESS(SVC_AGT,'account_char')) AS SERVICING_AGENT_ID,
...
--select count(*) from PRE_WORK2;     --620681
...
SOURCE_GENDER_CDE,
MARITAL_STATUS_CDE,
SOURCE_MARITAL_STATUS_CDE,                        --added source_marital_status_cde and government_id
GOVERNMENT_ID,
SOURCE_LOGIN_ID,
BEGIN_DT,
BEGIN_DTM,
...
A.SOURCE_MARITAL_STATUS_CDE,                        --added source_marital_status_cde and government_id
A.GOVERNMENT_ID,
A.SOURCE_LOGIN_ID,
A.BEGIN_DT,
A.BEGIN_DTM,
...
AND A.RW_NUM=B.RW_NUM-1; --Updated Rows	620681
