/*
    ...
    ---------------------------------------------------------------------------------------------------------------
    		               Party-Tier2         30/03           First Version Tier-2 
    ------------------------------------------------------------------------------------------------------------------
*/ 
...
'I' AS PARTY_TYPE_CDE,
ROW_NUMBER() OVER (PARTITION BY FIRST_NM,LAST_NM,PARTY_ID ORDER BY BEGIN_DTM DESC,END_DTM DESC) AS RNK
FROM(
SELECT 
...
FROM 
PROD_NBR_VW_TERSUN.NB_GRP_INFO_VW_0329 WHERE SRC_SYS_ID='77')Q_1
...
GROUP_CLASS_CDE,
BEGIN_BILLING_DT,
SECOND_DUE_DAY_TXT FROM PRE_WORK;
