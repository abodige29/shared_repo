...
/*
    ...
    FileName: party_cdamprlife_rel_party_agreement.sql
    Author: mm12874
    SUBJECT AREA : Party
    SOURCE: BENE_DATA_VW
    ...
    ---------------------------------------------------------------------------------------------------------------
    JIRA 3316              Party-Tier2            07/22         First Version of DML for Tier-2
...
TRUNCATE TABLE EDW_WORK.PARTY_CDAMPRLIFE_REL_PARTY_AGREEMENT;		/* Work table for MPR Beneficiary REL_PARTY_AGREEMENT */
...
SELECT 
	...
	A.REF_PARTY_ROLE_NATURAL_KEY_HASH_UUID,A.REF_PARTY_SUB_ROLE_NATURAL_KEY_HASH_UUID ORDER BY A.END_DTM ,A.BEGIN_DTM ) RW_NUM
...
INSERT INTO EDW_WORK.PARTY_CDAMPRLIFE_REL_PARTY_AGREEMENT 
(
DIM_AGREEMENT_NATURAL_KEY_HASH_UUID,
DIM_PARTY_NATURAL_KEY_HASH_UUID,
REF_PARTY_ROLE_NATURAL_KEY_HASH_UUID,
...
SELECT ANALYZE_STATISTICS('EDW_WORK.PARTY_CDAMPRLIFE_REL_PARTY_AGREEMENT');

DELETE FROM EDW.REL_PARTY_AGREEMENT WHERE SOURCE_SYSTEM_ID IN ('234','41') AND SOURCE_BENEFICIARY_ROLE_CDE='Bene' ;
...
BENEFICIARY_UNFORMATTED_NM
FROM
EDW_WORK.PARTY_CDAMPRLIFE_REL_PARTY_AGREEMENT;
