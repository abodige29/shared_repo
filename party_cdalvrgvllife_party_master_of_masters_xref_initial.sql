/*
    ...
    ---------------------------------------------------------------------------------------------------------------
    TERSUN-3388             Party-Tier2    08/24                Initial version      
    ------------------------------------------------------------------------------------------------------------------
*/
...
(
	...
	,COALESCE(BEN_FRST_NM,'')||COALESCE(BEN_MDL_NM,'')||COALESCE(BEN_LST_NM,'')||COALESCE(CARR_ADMIN_SYS_CD,'')||COALESCE(HLDG_KEY_PFX,'')||COALESCE(HLDG_KEY,'')||COALESCE(HLDG_KEY_SFX,'')||COALESCE(SUBSTRING(BEN_ARGMT_TXT,1,100),'')||COALESCE(BEN_ROW_CNTR_CD,'') AS PARTY_ID
	,COALESCE(BEN_FRST_NM,'')||COALESCE(BEN_MDL_NM,'')||COALESCE(BEN_LST_NM,'')||COALESCE(CARR_ADMIN_SYS_CD,'')||COALESCE(HLDG_KEY_PFX,'')||COALESCE(HLDG_KEY,'')||COALESCE(HLDG_KEY_SFX,'')||COALESCE(SUBSTRING(BEN_ARGMT_TXT,1,100),'')||COALESCE(BEN_ROW_CNTR_CD,'') AS PARTY_PRIOR_ID  
	,SOR_PARTY_ID
	,PARTY_ID_TYPE_CDE 
	,BEGIN_DT  
	,BEGIN_DTM  
