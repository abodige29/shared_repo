/*
    ...
    ---------------------------------------------------------------------------------------------------------------
    TERSUN-3388             Party-Tier2    06/03                Initial version      
    ------------------------------------------------------------------------------------------------------------------
--*/
...
,UUID_GEN(PARTY_ID)::UUID                                            AS DIM_PRIOR_PARTY_NATURAL_KEY_HASH_UUID  
...
DELETE FROM EDW.PARTY_MASTER_OF_MASTERS_XREF WHERE SOURCE_SYSTEM_ID IN ('246','85');
...
,UPDATE_AUDIT_ID   
,SOURCE_DELETE_IND  
FROM EDW_WORK.PARTY_CDALVRGVLLIFE_PARTY_MASTER_OF_MASTERS_XREF;
